    ...
    >
      <div className={styles.modal}>
        <div className={styles.header}>
          ...
          {isLoading && (
            <p className={styles.description}>正在加载访问选项...</p>
          )}
        </div>
          ...
          <>
            ...
            <div className={styles.group}>
              <h4 className={styles.groupTitle} style={{ color: "#f97316" }}>
                【推荐】{" "}
                <span className={styles.groupDescription}>推荐使用</span>
              </h4>
              <div className={styles.groupButtons}>
                <button
                  className={`${styles.actionBtn} ${styles.btnRecommend}`}
                  onClick={() => handleDownload(config.web.china, "link")}
                >
                  <span className={styles.btnIcon}>
                    <IconWeb />
                  </span>
                  <span className={styles.btnMain}>访问入口</span>
                ...
                <button
                  className={`${styles.actionBtn} ${styles.btnRecommend}`}
                  onClick={() =>
                    handleDownload(config.android.china, "download")
                  }
                >
                  <span className={styles.btnIcon}>
                    <IconAndroid />
            ...
            <div className={styles.group}>
              <div
                ...
                onClick={() =>
                  setInternationalExpanded(!isInternationalExpanded)
                }
                style={{
                  cursor: "pointer",
                  display: "flex",
              ...
              >
                ...
                <span
                  style={{
                    ...
                    transform: isInternationalExpanded
                      ? "rotate(180deg)"
                      : "rotate(0deg)",
              ...
              {isInternationalExpanded && (
                ...
                >
                  <button
                    className={styles.actionBtn}
                    onClick={() => handleDownload(config.web.global, "link")}
                  >
                    <span className={styles.btnIcon}>
                      <IconWeb />
                    </span>
                  ...
                  <button
                    className={styles.actionBtn}
                    onClick={() =>
                      handleDownload(config.android.global, "download")
                    }
                  >
                    <span className={styles.btnIcon}>
                      <IconAndroid />
            ...
            <div className={styles.footerNote}>已有账号的用户可直接登录。</div>
          </>
        ) : null}
